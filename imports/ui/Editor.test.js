...
if (Meteor.isClient) {
  describe('Editor', function () {
    ...
    it('should render no note found message', function () {
      const wrapper = mount(<Editor call={browserHistory} call={call} selectedNoteId={notes[0]._id}/>);
    ...
    it('should update the note body on the Textarea change', function () {
    ...
    it('should update the note title on the input change', function () {
    ...
    it('should set not state if nite prop not provided', function () {
      const wrapper = mount(<Editor browserHistory={browserHistory} call={call}/>);
